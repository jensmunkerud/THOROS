...
| Radio | `src/COMMS/RFD900` | 900MHz serial protocol; command RX + telemetry TX on FreeRTOS task |
| PID tuning | `src/COMMS/PidTuningReceiver` | Accepts PID gain updates at runtime via serial |
